...
export default function MyData() {
  return <section className='bg-white dark:bg-darkpurple border-2 border-y-mainpurple w-full flex py-16 items-start justify-evenly'>
    <div className='flex flex-col w-max pr-2'>
      ...
      <p className='dark:text-white inline-block mt-3'><TfiWorld className='h-5 w-5 inline mr-2' /> Lanús, Buenos Aires Argentina </p>
      <p className='dark:text-white inline-block mt-3'><AiOutlinePhone className='h-5 w-5 inline mr-2' /> +1126665538</p>
      <p className='dark:text-white inline-block mt-3'><AiOutlineMail className='h-5 w-5 inline mr-2' /> yonielkpo@gmail.com</p>
    </div>
