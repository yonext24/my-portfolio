...
export default function Project({ data, parentSetState, noGit, noDemo }) {
  ...
  return <article className='opacity-90 w-11/12 sm:w-9/12 min-[780px]:w-2/5 lg:w-1/3 relative group z-[5] hover:z-20 rounded-md min-w-[330px]'
    ...
    <div className='w-full h-full overflow-hidden rounded-lg'>
      <img src={data.image[0]} draggable='false' className='h-full w-full rounded-l-lg cursor-pointer group-hover:brightness-[.2]
