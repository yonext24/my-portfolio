  ...
  dark:from-darkpurple border-2 border-mainpurple mx-auto grid grid-cols-[45%,auto] gap-x-4 rounded-2xl py-6 px-6 '>
    ...
    <div className='w-[55] flex flex-col justify-between pl-4'>
      <div>
        ...
        <p className='text-lg text-[rgb(0,0,0,.9)] dark:text-[rgba(255,255,255,.7)] w-11/12'>{data.description[language]}</p>
      </div>
      <div className='mt-auto flex gap-2'>
        <div className='flex gap-2 items-end'>
          <a className='rounded-lg bg-rose2 py-1 px-2 flex items-center w-max gap-x-2' href={data.demo} target='_blank' >
            <TfiWorld className='h-5 w-5' />
            Demo
          </a>
          <a className='rounded-lg bg-rose2 py-1 px-2 flex items-center w-max gap-x-2' href={data.github} target='_blank' >
